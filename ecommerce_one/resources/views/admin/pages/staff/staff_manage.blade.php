                                ...
                                <div class="box-header">
                                    ...
                                    <div class="pull-right">
                                        <ul style="list-style: none ">
                                            <li><a href="{{route('staff_register')}}"><button class="btn btn-danger">Add staff</button></a></li>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    ...
                                                    @if($user->status=='1')
                                                    <a href="{{route('staff_manage_status',['id'=>$user->id])}}"><small class="badge bg-green">Active</small></a>
                                                    @else
                                                    <a href="{{route('staff_manage_status',['id'=>$user->id])}}"><small class="badge bg-red">Inactive</small></a>

                                                    @endif
                                                </td>

                                                <td class="center">
                                                    <a href="{{route('staff_manage_edit',['id'=>$user->id,'access_id'=>$user->admin_access_level])}}"> <button class="btn btn-edit btn-sm" data-widget='collapse' data-toggle="tooltip" title="Edit Profile"><i class="fa fa-edit"></i></button></a>
                                                    <a href="{{route('staff_manage_delete',['id'=>$user->id])}}"> <button class="btn btn-danger btn-sm" data-widget='remove' data-toggle="tooltip" title="Remove Staff"><i class="fa fa-times"></i></button></a>
