...
<aside class="right-side">                
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <form method="POST" role="form" action="{{route('admin_manage_update',['id'=>$datam->id])}}">
                {!! csrf_field() !!}
                <div class="box-body">
                    
                    <div class="form-group">
                        <label for="exampleInputName">Name</label>
                        <input type="text" name="name" value="{{$datam->name}}" class="form-control" id="exampleInputName" placeholder="Admin Name">
                    </div>
