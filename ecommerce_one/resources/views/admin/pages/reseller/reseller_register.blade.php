...
<aside class="right-side">                
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form method="POST" role="form" action="{{route('reseller_register')}}">
                {!! csrf_field() !!}
                <div class="box-body">
                    <div class="form-group">
                        <label for="exampleInputName">Name</label>
                        <input type="text" name="name" value="{{old('name')}}" class="form-control" id="exampleInputName" placeholder="Reseller Name">
                    </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="exampleInputdate">Joining Date</label>
                           <input type="date" name="reseller_joining_date" value="{{old('reseller_joining_date')}}" class="form-control" id="exampleInputdate"  placeholder="Enter date">
                    </div>
                    <div class="form-group">
