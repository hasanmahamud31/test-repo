...
<aside class="right-side">                
    ...
    <section class="content-header">
        <h1>
            <small>Register Subcategory Page</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form method="POST" role="form" action="{{route('store_subcategory')}}">
                {!! csrf_field() !!}
                <div class="box-body">
                    <div class="form-group">
                        <label for="exampleInputName">Name</label>
                        <input type="text" name="name" value="{{old('name')}}" class="form-control" id="exampleInputName" placeholder="Subcategory Name">
                    </div>
