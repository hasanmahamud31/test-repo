...
<aside class="right-side">                
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form method="POST" role="form" action="{{route('user_register')}}">
                {!! csrf_field() !!}
                <div class="box-body">
                    <div class="form-group">
                        <label for="exampleInputName">Name</label>
                        <input type="text" name="name" value="{{old('name')}}" class="form-control" id="exampleInputName" placeholder="User Name">
                    </div>
