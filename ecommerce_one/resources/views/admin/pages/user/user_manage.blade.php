                            ...
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <div class="pull-right">
                                        <ol class="breadcrumb">
                                            <li><a href="{{route('user_register')}}">Add user</a></li>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    ...
                                                    @if($user->status=='1')
                                                    <a href="{{route('user_manage_status',['id'=>$user->id])}}"><small class="badge bg-green">Active</small></a>
                                                    @else
                                                    <a href="{{route('user_manage_status',['id'=>$user->id])}}"><small class="badge bg-red">Inactive</small></a>

                                                    @endif
                                                </td>

                                                <td class="center">
                                                    <a href="{{route('user_manage_edit',['id'=>$user->id,'access_id'=>$user->admin_access_level])}}"> <button class="btn btn-edit btn-sm" data-widget='collapse' data-toggle="tooltip" title="Edit Profile"><i class="fa fa-edit"></i></button></a>
                                                    <a href="{{route('user_manage_delete',['id'=>$user->id])}}"> <button class="btn btn-danger btn-sm" data-widget='remove' data-toggle="tooltip" title="Remove User"><i class="fa fa-times"></i></button></a>
